...
const updateQuery = `
-- Drop all potential variations to clear ambiguity
DROP FUNCTION IF EXISTS move_orders_to_bill_json(TEXT, INTEGER);
DROP FUNCTION IF EXISTS move_orders_to_bill_json(INTEGER, TEXT, INTEGER);
DROP FUNCTION IF EXISTS move_orders_to_bill_json(INTEGER, INTEGER, INTEGER);
...
async function runUpdate() {
    ...
    try {
        console.log("Cleaning up and updating stored procedure...");
